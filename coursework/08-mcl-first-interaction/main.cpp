...
int main()
{
    ...
    // DONE: Set robot new position to x=10.0, y=10.0 and orientation=0
    ...
    // DONE: Rotate the robot by PI/2.0 and then move him forward by 10.0
    // Use M_PI for the pi value
    myrobot.move(M_PI * 0.5, 10.0);

    // DONE: Print out the new robot position and orientation
    cout << myrobot.show_pose() << endl;
...
// [x=10.000000 y=10.000000 orient=0.000000] [x=10.000000 y=20.000000 orient=1.570796] [10.000000 60.827625 31.622777 40.000000 72.111026 92.195445 70.000000 76.157731]
