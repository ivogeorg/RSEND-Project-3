...
int main()
{
    // DONE: Instantiate a robot object from the Robot class
    Robot rob;


    // DONE: Set robot new position to x=30.0, y=50.0 and orientation=PI/2
    rob.set(30.0, 50.0, M_PI / 2.0);


    // DONE: Turn clockwise by PI/2 and move by 15 meters
    rob.move(- M_PI / 2.0, 15.0);   // NOTE: CW is negative!


    // DONE: Print the distance from the robot toward the eight landmarks
    cout << rob.read_sensors() << endl;


    // DONE: Turn clockwise by PI/2 and move by 10 meters
    rob.move(- M_PI / 2.0, 10.0);
