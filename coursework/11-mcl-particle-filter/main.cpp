...
int main()
{
    ...
    //DONE: Your job is to loop over the set of particles
    for (int i = 0; i < n; i ++) {
        //DONE: For each particle add noise: Forward_Noise=0.05, Turn_Noise=0.05, and Sense_Noise=5.0
        p[i].set_noise(0.05, 0.05, 5.0);
        //DONE: And print its pose on a single line
