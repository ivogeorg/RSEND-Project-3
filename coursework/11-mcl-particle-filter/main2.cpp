...
int main()
{
    ...
    //DONE: Create a new particle set 'p2
    Robot p2[n];
    
    //DONE: Rotate each particle by 0.1 and move it forward by 5.0
    //DONE: Assign 'p2' to 'p' and print the particle poses, each on a single line
    for (int i = 0; i < n; i++) {
